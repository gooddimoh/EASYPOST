...
const CreateShipment = ({ className, handleSetActive }) => {
    const status = `'status': true,`;
    const message = `'message': {`;
    const shipmentId = `'shipment_id': 'shp_e10843dbab00454db38e90b2ebdb6a04',`;
    const columns = `'columns': [`;
    const serviceType = `'service_type',`;
    const amount = `'amount',`;
    const timeDelivery = `'time_delivery'`;
    const items = `'items': [`;
    const itemId1 = `'id': 'rate_b0218856ecf144f0af663841cbded3b4',`;
    const itemServiceType1 = `'service_type': 'USPS Priority',`;
    const itemAmount1 = `'amount': 1732,`;
    const itemTimeDelivery1 = `'time_delivery': 1`;
    const itemId2 = `'id': 'rate_6028e8d462ed46a5b5c3636d870f286f',`;
    const itemServiceType2 = `'service_type': 'FedEx FEDEX_GROUND',`;
    const itemAmount2 = `'amount': 2298,`;
    const itemTimeDelivery2 = `'time_delivery': 2`;
    ...
    return (
        <div className="api-integration__block accordion">
            <div className={`accordion__box ${className}`} onKeyDown={handleSetActive} onClick={handleSetActive}>
                <div className="accordion__title">Create Shipment</div>
                <Img className="accordion__icon" img="arrow-dropdown" alt="arrow dropdown" />
            </div>
            <div className={`accordion__info ${className}`}>
                <div className="accordion__method"><span>POST</span> https://erp.loc/api/labels/get-shipment-rates</div>
                ...
                <div className="accordion__item">
                    ...
                    <div className="accordion__block">
                        ...
                        <div className="accordion__block-code">
                            ...
                            <div className="accordion__block-text accordion__block-text_pl-2">{shipmentId}</div>
                            ...
                            <div className="accordion__block-text accordion__block-text_pl-4">{timeDelivery}</div>
                            ...
                            <div className="accordion__block-text accordion__block-text_pl-2">{itemTimeDelivery1}</div>
                            <div className="accordion__block-text">{'},'}</div>
                            <div className="accordion__block-text">{'{'}</div>
                            ...
                            <div className="accordion__block-text accordion__block-text_pl-2">{itemTimeDelivery2}</div>
                            <div className="accordion__block-text">{'}'}</div>
                            <div className="accordion__block-text">]</div>
                            <div className="accordion__block-text">{'}'}</div>
                        </div>
...
export default compose(withTagDefaultProps, AccordionHoc)(CreateShipment);