...
import { InfoAddressBooksSender } from 'InfoManual';
...
const SenderTab = ({ t, forceFetch, service: { deleteItem, url } }) => {
    ...
    return (
        <>
            <TopTitleWrap title="All senders" info={<InfoAddressBooksSender />}>
                <DefaultButtonLink src={`/${url}/sender`}>{t('Add sender')}</DefaultButtonLink>
            </TopTitleWrap>
